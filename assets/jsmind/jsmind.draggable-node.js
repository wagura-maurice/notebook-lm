...
(function ($w) {
  "use strict";
  console.warn(
    "The version is outdated. see details: https://hizzgdev.github.io/jsmind/es6/"
  );
  var $d = $w.document;
  var __name__ = "jsMind";
  ...
  var options = {
    line_width: 5,
    line_color: "rgba(236, 43, 247, 0.3)",
    lookup_delay: 500,
    lookup_interval: 80,
  ...
  jsMind.draggable.prototype = {
    ...
    drag: function (e) {
      ...
      if (this.capture) {
        ...
        if (
          e.clientY - this.view_panel_rect.top <
            options.scrolling_trigger_width &&
          ...
          this.view_panel_rect.bottom - e.clientY <
            options.scrolling_trigger_width &&
        ...
        if (
          e.clientX - this.view_panel_rect.left <
            options.scrolling_trigger_width &&
          ...
          this.view_panel_rect.right - e.clientX <
            options.scrolling_trigger_width &&
