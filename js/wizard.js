          ...
          try {
            ...
            if (quill) {
              ...
              const aiResponseHTML = `
                <h1 style="color: var(--eu-blue)">AI-Generated Document</h1>
                <h2 style="color: var(--eu-blue)">Based on your request: "${message}"</h2>
                <p style="color: var(--eu-blue)">Here is a comprehensive document based on your request. This content is generated by the AI and inserted into the editor.</p>
                <h3 style="color: var(--eu-blue)">Key Points:</h3>
                <ul style="color: var(--eu-blue)">
                ...
                <h3 style="color: var(--eu-blue)">Summary</h3>
                <p style="color: var(--eu-blue)">This is a summary of the AI's response to your query. The content is fully editable and can be modified as needed.</p>
              `;
...
const SourceActions = {
  ...
  addSource: function (name, type, content) {
    ...
    const $newSource = $(`
      <li class="group py-2 px-3 hover:bg-eu-blue/50 hover:bg-eu-orange rounded cursor-pointer flex items-center relative source-item">
        ...
        <input type="checkbox" class="ml-2 source-checkbox rounded border-eu-blue/50 text-eu-blue focus:ring-eu-blue" />
        <div class="source-menu hidden absolute right-3 top-10 bg-eu-white bg-eu-orange rounded-md shadow-lg py-1 w-48 border border-eu-blue/20 z-30">
          <a href="#" class="flex items-center px-4 py-2 text-sm text-eu-blue hover:bg-eu-blue/10 hover:bg-eu-orange/10 menu-option">
      ...
      .on(
        ...
        function () {
          ...
          $("#discover-source-modal .p-3.selected").removeClass(
            "selected bg-eu-blue dark:bg-eu-blue"
          );
          $("#discover-source-modal .p-3 button")
            .removeClass("remove-btn bg-red-600 hover:bg-red-700 text-white")
            .addClass(
              "add-btn text-eu-blue hover:text-eu-orange dark:text-eu-blue dark:hover:text-eu-orange"
            )
            .text("Add");
      ...
      .on(
        ...
        function () {
          ...
          if ($item.hasClass("selected")) {
            $item.removeClass("selected bg-eu-blue dark:bg-eu-blue").addClass("bg-eu-blue dark:bg-eu-blue");
            $btn
              .removeClass("remove-btn bg-red-600 hover:bg-red-700 text-white")
              .addClass(
                "add-btn text-eu-blue hover:text-eu-orange dark:text-eu-blue dark:hover:text-eu-orange"
            ...
            $item.addClass("selected bg-eu-blue dark:bg-eu-blue");
            $btn
              .removeClass(
                "add-btn text-eu-blue hover:text-eu-orange dark:text-eu-blue dark:hover:text-eu-orange"
              )
  ...
  showSourceContent: function (e) {
    ...
    const viewForm = $(`
      <div class="flex flex-col h-full expanded-content view-source-content">
        <div class="flex items-center justify-between px-5 py-3 border-b border-eu-gray-700">
          <h3 class="text-lg font-semibold">View Source</h3>
          <button id="back-to-sources" class="text-eu-blue-400 text-lg hover:text-eu-orange transition-colors">
            <i class="fas fa-arrow-left hover:text-eu-orange transition-colors"></i>
          </button>
        </div>
        <div class="flex-1 w-full overflow-y-auto py-1 scrollbar-transparent">
          <h3 class="font-medium text-eu-blue-400 p-4">${title}</h3>
          
          <div class="source-content-section p-4">
            <h4 class="text-sm font-semibold text-eu-gray-300 mb-2">Summary</h4>
            <p class="text-sm text-eu-gray-400">This document provides a comprehensive overview of key concepts and methodologies in the field. It covers fundamental principles and practical applications while exploring various aspects of the subject matter.</p>
          </div>
          
          <div class="source-content-section p-4">
            <h4 class="text-sm font-semibold text-eu-gray-300 mb-2">Key Topics</h4>
            <div class="source-topics-list">
              <span class="source-topic-tag hover:bg-eu-blue-600 cursor-pointer transition-colors" data-topic="Methodology">Methodology</span>
              <span class="source-topic-tag hover:bg-eu-blue-600 cursor-pointer transition-colors" data-topic="Analysis">Analysis</span>
              <span class="source-topic-tag hover:bg-eu-blue-600 cursor-pointer transition-colors" data-topic="Research">Research</span>
              <span class="source-topic-tag hover:bg-eu-blue-600 cursor-pointer transition-colors" data-topic="Data Collection">Data Collection</span>
              <span class="source-topic-tag hover:bg-eu-blue-600 cursor-pointer transition-colors" data-topic="Results">Results</span>
            </div>
          </div>
          
          <div class="source-content-section p-4 flex-1 overflow-hidden">
            <h4 class="text-sm font-semibold text-eu-gray-300 mb-2">Content</h4>
            <div class="flex-1 overflow-y-auto text-eu-gray-400 space-y-4">
  ...
  showChatAboutSourcesContent: function (e) {
    ...
    const viewChatWithSourcesContent = $(`
      <div class="flex flex-col h-full expanded-content view-source-content">
        <div class="flex items-center justify-between px-5 py-3 border-b border-eu-blue-600">
          <h3 class="text-lg font-semibold text-eu-blue-600">Chat Sources</h3>
          <button id="back-to-sources" class="text-eu-blue-600 text-lg hover:text-eu-orange transition-colors">
            <i class="fas fa-arrow-left hover:text-eu-orange transition-colors"></i>
          </button>
        </div>
        ...
        <!-- Chat Messages -->
        <div
          class="flex-1 flex flex-col overflow-hidden bg-eu-gray-700"
        >
          <div
            id="left-column-chat-message-welcome-message"
            class="text-center text-eu-gray-300 py-12"
          >
            <div
              class="inline-flex items-center justify-center w-16 h-16 rounded-full bg-eu-gray-800 mb-4"
            >
              <i class="fas fa-robot text-3xl text-eu-purple-600 hover:text-eu-orange transition-colors"></i>
            </div>
            <h3 class="text-xl font-semibold text-eu-gray-300 mb-2">
              How can I help with your sources today?
            </h3>
            <p class="text-eu-gray-400 text-sm px-4">
              Ask me anything about your sources or request help with writing,
              editing, or organizing your thoughts.
            </p>
          </div>
          <!-- Messages will be inserted here by JavaScript -->
          <div id="left-column-chat-messages-container" class="flex-1 overflow-y-auto px-5 py-3 space-y-4 scrollbar-transparent bg-white"></div>
        </div>
        ...
        >
          <button
            ...
            class="bg-eu-blue-600 text-white rounded-full py-2 px-6 shadow-md hover:bg-eu-blue-700 focus:outline-none transition-opacity duration-300 opacity-0 pointer-events-none"
          >
            Jump to Bottom
          </button>
        </div>
        ...
        <!-- Message Input -->
        <div class="border-t-2 border-eu-blue-700">
          <form id="left-column-chat-form" class="p-3 bg-eu-gray-700">
            <div class="relative">
              <textarea
              ...
              <button
                ...
                class="absolute right-3 bottom-3 text-eu-blue-400 hover:text-eu-blue-500 p-1 rounded-full transition-colors"
              >
                <i class="fas fa-paper-plane text-sm hover:text-eu-orange transition-colors"></i>
              </button>
            </div>
          </form>
        </div>
    ...
    const loadingMessage = $(`
      <div class="w-full px-4 py-2">
        <div class="flex items-center space-x-2">
          <div class="w-2 h-2 rounded-full bg-eu-white opacity-75 animate-bounce"></div>
          <div class="w-2 h-2 rounded-full bg-eu-white opacity-50 animate-bounce" style="animation-delay: 0.2s"></div>
          <div class="w-2 h-2 rounded-full bg-eu-white opacity-25 animate-bounce" style="animation-delay: 0.4s"></div>
        </div>
      </div>
    `);
...
const LeftColumnChatModule = {
  ...
  simulateLeftColumnAIResponse: function (userMessage) {
    ...
    setTimeout(() => {
      ...
      const responseDiv = $(`
        <div class="w-full px-4 py-2 group bg-eu-white-100">
            <div class="text-eu-black text-sm">
              ${response}
            </div>
            <div class="flex justify-between items-center mt-2">
              ...
              <div class="flex gap-3">
                ...
                <button
                  class="text-xs text-eu-black hover:text-eu-orange text-sm flex items-center copy-message-btn opacity-0 group-hover:opacity-100 active:opacity-100 transition-opacity px-2 py-1 rounded hover:bg-eu-white-100"
                >
  ...
  showTypingIndicator: function () {
    const typingIndicator = $(`
      <div class="typing-indicator flex justify-start mb-4 px-2">
        <div class="max-w-[80%] bg-eu-white rounded-xl rounded-bl-none px-4 py-2">
          <div class="flex items-center space-x-1">
            <div class="w-2 h-2 rounded-full bg-eu-blue animate-bounce"></div>
            <div class="w-2 h-2 rounded-full bg-eu-blue animate-bounce" style="animation-delay: 0.2s"></div>
            <div class="w-2 h-2 rounded-full bg-eu-blue animate-bounce" style="animation-delay: 0.4s"></div>
          </div>
        </div>
      </div>
    `);
